        ...
        <div class="admin-panel m-3">
            <form action="{{ action("Admin\ProductController@store") }}" method="post">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-4">
                        <div class="md-form">
                            <input type="checkbox" id="featured" name="featured" class="form-control">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="md-form">
                            <input id="statie_geld" name="statie_geld" type="number" step="0.01" min="0" value="0">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="md-form">
                            <input type="number" id="coli" name="coli" step="1" min="0" value="0">
                            <label for="coli">Coli</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="md-form">
                            <input type="number" id="weight" name="weight" step="1" min="0" value="0">
                            <label for="weight">Gewicht (gram)</label>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="md-form">
                            <input type="number" id="volume" name="volume" step="1" min="0" value="0">
